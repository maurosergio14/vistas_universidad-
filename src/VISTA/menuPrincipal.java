...
public class menuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu5.setText("Carga de Nota");

        jMenuItem6.setText("Manipular Nota");
        ...
        jMenuItem7.setText("Listado de Alumnos x Materia");
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        escritorio.removeAll();
        escritorio.repaint();
        AlumnosMateriav av = new AlumnosMateriav();
        av.setVisible(true);
        escritorio.add(av);
        escritorio.moveToFront(av);
        // TODO add your handling code here:
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        escritorio.removeAll();
        escritorio.repaint();
        VistasInscripciones av = new VistasInscripciones();
        av.setVisible(true);
        escritorio.add(av);
        escritorio.moveToFront(av);
